...
Purpose:       This code produces the bootstrap p-values described in Appendix D to account for the 
			   variance in estimating the candidate-level variables.
----------------------------------------------------------------------------------------------------
...
reg `y'  i.T_FB##c.zz `vSel' , cluster(ID)
local G=e(N_clust)
...
* Panel B: Different Ads
 ...
 reg `y'  i.Treat_Ads##c.zz  `vSel'  , cluster(ID)
...
reg `y'  i.Treat_Letter##c.zz  `vSel'  , cluster(ID)
...
reg `y'  i.Treat_Letters##c.zz  `vSel'  , cluster(ID)
...
* Panel B: Different Ads
 ...
 reg `y'  2.Treat_Ads##c.zz 3.Treat_Ads##c.zz  `vSel'  , cluster(ID)
...
matrix est[4,`m']=_b[3.Treat_Ads#c.zz]
 ...
 reg `y'  1.Treat_Ads##c.zz 3.Treat_Ads##c.zz  `vSel'  , cluster(ID)
...
matrix est[7,`m']=_b[3.Treat_Ads#c.zz]
 ...
 reg `y'  1.Treat_Ads##c.zz 2.Treat_Ads##c.zz  `vSel'  , cluster(ID)
...
reg `y'  2.Treat_Letter##c.zz   `vSel'  , cluster(ID)
...
reg `y'  1.Treat_Letter##c.zz  `vSel'  , cluster(ID)
...
reg `y'  2.Treat_Letters##c.zz 3.Treat_Letters##c.zz  `vSel'  , cluster(ID)
...
reg `y'  1.Treat_Letters##c.zz 3.Treat_Letters##c.zz  `vSel'  , cluster(ID)
...
reg `y'  1.Treat_Letters##c.zz 2.Treat_Letters##c.zz  `vSel'  , cluster(ID)
...
quietly: reg yhat1`m'  i.T_FB##c.zz `vSel' , cluster(ID)
...
quietly:reg yhat2`m' i.Treat_Ads##c.zz  `vSel'  , cluster(ID)
...
quietly:reg yhat3`m' i.Treat_Ads##c.zz  `vSel'  , cluster(ID)
...
quietly:reg yhat4`m' i.Treat_Ads##c.zz  `vSel'  , cluster(ID)
...
quietly:reg yhat5`m'  i.Treat_Letter##c.zz  `vSel'  , cluster(ID)
...
quietly:reg yhat6`m'  i.Treat_Letter##c.zz  `vSel'  , cluster(ID)
...
quietly:reg yhat7`m'  i.Treat_Letters##c.zz  `vSel'  , cluster(ID)
...
quietly:reg yhat8`m'  i.Treat_Letters##c.zz  `vSel'  , cluster(ID)
...
quietly:reg yhat9`m'  i.Treat_Letters##c.zz  `vSel'  , cluster(ID)
...
mat2txt, matrix(pvalues) saving("$out/wildbootrap_pvals") format(%9.3f) replace
